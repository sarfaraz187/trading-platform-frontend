  ...
  const renderAuthLinks = (isMobile = false) => {
    ...
    if (user) {
      ...
      const loginLink = (
        <Link
          href="/login"
          className={`${commonLinkClasses} ${isMobile ? mobileLinkClasses : ''}`}
          prefetch={false}
        >
        ...
        <SheetContent side="right">
          <nav className="grid gap-4 py-6 text-lg font-medium">
             ...
             <SheetClose asChild>
                 <Link
                    href="/"
                    className="text-muted-foreground transition-colors hover:text-foreground flex items-center gap-2 px-2.5"
                    prefetch={false}
                 >
            ...
            <div className="grid gap-4 px-2.5">
